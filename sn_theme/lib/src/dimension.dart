...
class Dimension {
  ...
  DimensionSide _left = DimensionSide(0, SidesFlag(1, 0, 0, 0));
  DimensionSide _top = DimensionSide(0, SidesFlag(1, 0, 0, 0));
  DimensionSide _right = DimensionSide(0, SidesFlag(1, 0, 0, 0));
  DimensionSide _bottom = DimensionSide(0, SidesFlag(1, 0, 0, 0));
  DimensionSide _x = DimensionSide(0, SidesFlag(1, 0, 0, 0));
  DimensionSide _y = DimensionSide(0, SidesFlag(1, 0, 0, 0));
  DimensionSide _all = DimensionSide(0, SidesFlag(1, 0, 0, 0));;
